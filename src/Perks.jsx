...
export default function Perks({selected,onChange}){
    ...
    return (
         <>
          <label className=" border  border-black p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
            ...
            <label className="border   border-black p-4 flex rounded-2xl gap-2 items-center cursor-pointer">
                ...
                <span>{t('place de parking gratruit')}</span>
            </label>
          ...
          <input type="checkbox"  checked={selected.includes('animaux')} name="animaux" onChange={handleCbClick} />
